    ...
    <div className="min-h-screen bg-[var(--paper)]">
      <div className="mx-auto max-w-[1160px] px-6 py-12 md:px-10">
        ...
        <Link
          ...
          className="mt-8 flex items-center justify-between rounded-2xl border border-dashed border-[var(--amber)] bg-[var(--amber)]/[0.06] px-6 py-5 transition-all duration-300 hover:border-[var(--amber)] hover:bg-[var(--amber)]/[0.1] hover:shadow-md"
        >
