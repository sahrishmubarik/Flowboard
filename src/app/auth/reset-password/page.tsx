...
import {
  resetPasswordFormSchema,ResetPasswordFormInput
...
const mutation = useMutation({
  mutationFn: async (
    formData: ResetPasswordFormInput
  ) => {
    if (!token) {
      throw new Error(
...
const onSubmit = (
  ...
  return (
    <div className="flex w-full items-center justify-center bg-zinc-50 px-4 min-h-screen">
